                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            ] else if (_topic!.deckId != null) ...[
                              InkWell(
                                onTap: () {
                                  if (_topic!.cardId != null) {
                                    _showCardPreview(context, _topic!.deckId!, _topic!.cardId!);
                                  } else {
                                    context.push('/flashcard-deck/${_topic!.deckId}/details');
                                  }
                                },
                                borderRadius: BorderRadius.circular(6),
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                        child: Builder(
                                          builder: (context) {
                                            final label = _topic!.cardId != null
                                                ? '${_topic!.deckTitle ?? "Flashcards"} > ${_topic!.cardQuestionText ?? "Card Question"}'
                                                : (_topic!.deckTitle ?? "Flashcards");
                                            return Text(
                                              label,
                                              style: const TextStyle(
                                                fontSize: 9,
